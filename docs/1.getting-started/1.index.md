...
**WPNuxt v2** is a complete rewrite for Nuxt 4, with a simplified API, better TypeScript support, and new features like server-side caching and AI tooling. [See what's new →](#whats-new-in-v2)
::
