...
::callout{type="tip"}
If you use a WordPress SEO plugin like Yoast or RankMath, you can expose its data via GraphQL with plugins like [WPGraphQL for Yoast SEO](https://github.com/developer-developer/developer-developer) and fetch it using a [Custom Query](/guide/custom-queries).
::
...
- **[Custom Queries](/guide/custom-queries)** — Fetch SEO plugin data (Yoast, RankMath) via custom queries
- **[Performance](/guide/performance)** — Core Web Vitals and performance optimization
