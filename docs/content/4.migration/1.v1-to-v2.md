...
**AI-Assisted Migration:** If you're using an AI assistant with the [WPNuxt MCP server](/mcp), the `wpnuxt_migrate` tool can automatically scan your v1 project, identify breaking changes, detect usage anti-patterns (like composables called inside `onMounted` that break SSR), and generate compatibility helpers. Simply ask your AI assistant to "help me migrate to WPNuxt v2" with your project files.
::
